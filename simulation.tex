...
\subsection{Effects}
%%%The core effects that we are looking for are the relationships between the resulting system via evolution, which can be measured with the criteria, 
%%%compared to the strategies that are involved.

%%%Essentially what we want is a table with the strategies laid out in the columns and with how they effect different criteria
