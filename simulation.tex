...
%%%How do we differ, what are we ignoring as aspects that do not occur in our simulation.
...
%%%What strategies are currently used, a 
...
%%%We will then have control strategies that do not require criteria, 
%%%the first is install the system and never do anything. Clearly very quickly it will become out of date, how quickly is an interesting question.
%%%The second and thrid control strategies will be a strategy of updateing once a week and once a day. How much change does this require,
%%%is updating once a week enough for a system with nothing extra installed. Does coupling increase, like Lehamn would predict under such a strategy?

%%%After this we can add criteria, and installation strategies. How about updating daily, installing by-daily, with X strategy, compare to installing weekly.
%%%If you install daily v.s. weekly with X strategy and updating daily, have much of an effect on your system?

%%%And so on, by altering the variables in the configuration, we can answer questions that currently have no answer.
