...
\end{itemize} 
The request to install the selected component is then added to the template ten minutes after the initial time $t_0$ plus the number of elapsed dates.
...
This control file was tagged with the upload date of the package to the Ubuntu Repository.

The control files are a very similar format to the CUDF format, as CUDF was largely based on this format.
An example of these files can be seen in section \ref{background.debianPackages}.
The conversion between Debian and CUDF is documented 
