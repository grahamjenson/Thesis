...
\usermodel is presented in section \ref{sim.usermodel} and the variables, information, and assumptions for the simulation are discussed.
...
It was completed by 59 users, who answered questions about their background, the systems they use, and the ways they change their component systems.
In GNU/Linux system typically the way in which component systems are changed is through interaction with package manager applications. 
...
\begin{itemize}
  \item \texttt{apt-pinning} priorities are ignored
...
\end{enumerate}
A user would not likely select to install many of the available packages in the Ubuntu repository.
