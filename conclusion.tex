...
Through such simulation the conclusions of this research can be shown to be invariable between component systems 
or be Ubuntu-specific.
...
This research proposed novel ways to reduce negative effects during CSE and the tools in which to measure the effectiveness of these proposals.
