...
\texttt{-uptodatedistance} 	& $crit_{uptodatedistance} = \langle rank^{uptodatedistance}_{\alpha}, \leq \rangle$ & $\langle f_{uptodatedistance}, <, I_{uptodatedistance} \rangle$ \\
\texttt{-stableversion(N)} 	& $crit_{stableversion} = \langle rank^{stableversion}_{\alpha}, \leq \rangle$ & $\langle f_{stableversion}, <, I_{stableversion} \rangle$ \\
\end{tabular}
