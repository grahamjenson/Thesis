...
Other methods, e.g. collecting information from real systems, would not allow the study of novel techniques that a simulation allows.

%TODO REAL data cannot be used because it is difficult to change
%TODO Theoritical study of evolution would be less valid and have little impact
