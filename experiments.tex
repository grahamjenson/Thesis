...
This table shows that users that the ``High Install'' and ``High Upgrade'' users will have the most benefit using the stable version criterion.
This is likely due to their high probabiltiy to upgrade their systems.
