\chapter{Background}
\label{background}
\epigraph{For the present purposes, with the accuracy we want at first, we don't have to be very careful about defining things very precisely
...
The other says \textit{``What do you mean by know? What do you mean by talk? What do you mean by you?''}.

\textbf{In order to agree to talk, we just have to agree we are talking about roughly the same thing!}
}
{\textit{Paraphrased from The Feynman lectures on physics, Motion, Richard Feynman, 1961.}}
