...
%%%Conclusion
The use of component based systems can lower the complexity which in turn helps its evolution.
...
The composition of components means that a combinatorial amount of systems could be created.
...
The relationships between component represent constraints on the system that must be satisfied to create a valid component composition.
These constraints must be satisfied when evolving a system.
...
For these constraints to be automatically satisfied, the relationships between component must be explicit and computer readable.
This enables the function Component Dependency Resolution (CDR) \cite{Jenson2010} to be used to resolve these constraints and evolve a component system.
Use of this function lowers the cost of evolving a system, and allows for different criteria to be specified to guide evolution.
This function is implemented in many different systems, in many component models, all with the general goal of automatically altering a component system.
...
Both these areas have already been discussed in this chapter which will be used define the concept of ``software component''.
