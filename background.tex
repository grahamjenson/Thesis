...
This realisation, that software requires significant expense to maintain, led researchers to study how software changed after deployment.
...
Current research into solutions to the selection problem asks the questions:
\begin{itemize}
...
The problems encountered when trying to exactly define a software component may stem from the fact that ``component'' is a broad concept.
...
As such, this software component definition will not agree with every persons idea of what a software component is, but (as described above) no precise view can.
By only looking at aspects that are necessary for this research, the arguments over unnecessary aspects can be eliminated. 
...
The specification of OBR does not define a method or parameters to define preferences when selecting a component system.
...
This hierarchical nature of composition, actually means the system of components can itself be a component.
...
CUDF was created by the Mancoosi project to foster interest in this domain and to be used in a competition that compared CDR functionality.
