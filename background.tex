...
Other studies look at aspects like the evolution of specifications \cite{Mencl2001}, the specifications to version components in the component model \cite{Stuckenholz2005},
...
Though the differences between the two processes are significant.
...
The process of component system evolution is empirically studied in \cite{fortuna2011} by looking at the first 10 releases of the Debian Linux/GNU distribution.
This study uses graph metrics to analyse the evolution of the complexity of the software releases, and then compares the results to its biological counter part to shed light on both processes.
A system to evolve a component system using mutiple sources of components to install the newset versions is discuesed in \cite{Ryan2005}.
The evolution of a robot built as a set of OSGi components is studied in the paper \cite{Luo2004}
The mitigation of the negative effects caused by evolution is discussed in the paper \cite{Stuckenholz2007}.
...
Should a component be removed, should it be added, should the system be upgraded and what criteria should any of these actions optimise the change for.
The fears that guide these decisions are caused by the risk that change will damage the system, and the risk that not changing will leave the system out of date.
These two risks are most extremely representd by the sterotypes of conservative and progressive evolutionary strategies.


The research presented in \cite{Ryan2005}, states that a component should always be as uptodate as possible.
This is a clearly risky 

\cite{Lehman2006} Conservation of Familiarity requires that a system evolve not so much as to 
