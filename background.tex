...
That is software maintenance is a range of activities through which software is changed, and software evolution occurs as the system is repeatedly changed.
...
\section{Summary}
In this chapter, first software evolution, CBSE and the use of component systems were discussed and the history and connections between these domains were described.
The evolution of individual components and the evolution of component systems were then described and compared.
As this research centers around software components, it is necessary to discuss their definition.
The difficulty in giving an accurate and agreeable definition to ``software component'' was discussed. 
A definition of ``software component'' with respect to CSE is then presented as an incomplete definition that is sufficient for the purposes of this research.
Various component models that conform to this definition are then presented and discussed, and their properties explored and compared.
In the next chapter the concepts discussed in this chapter, such as software component, are formally defined as the first step to creating a simulation of CSE.
