...
This can be seen though the classification from \citep{Crnkovic2011}, of what a component model should define, partially enumerated:
\begin{itemize}
  \item Lifecycle 
  		\begin{itemize}
	  		\item Modelling
...
In the study from \citep{abate2011}, this package manager was compared against other component solvers, such as apt and aptitude, and shown to be an improvement.
