...
Composer's are also the ``changers'' of a system, as they have the power to alter the composition of components that make the system.
As the composer changes the component system, the component system is said to evolve.
...
The change of a component system is an activity performed by the composer, and CSE occurs over many such changes.  
...
However, recently the user has started to fill the composer role, where they compose and change systems to satisfy their requirements.
...
%%%Defining components
How ``software component'' is defined will impact how component system evolution is viewed.
