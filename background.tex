...
CDR systems typically provide similar functionality that allow the user to \textbf{install} and \textbf{remove} components, they add or remove a component to or from the system.
