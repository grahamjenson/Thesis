...
\section{Summary}
This chapter described the model \modelname was presented to describe CSE as a series of alterations to a system in response to repeated requests from the user to change.
The syntax CUDF* was then presented, 
and through a detailed example it was shown how a CUDF* document could be parsed to a \modelname instance.
These artifacts can be used to describe the evolution of component systems, however neither of them describe the user's that drive the evolution of a system.
To simulate the evolution of a system, the following chapter explores and models how a user would realistically request a system to be changed.
This user model together with \modelname and CUDF* can be used to realistically describe situations of CSE that can then be simulated. 
