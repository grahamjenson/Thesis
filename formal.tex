...
%%%CDR can return potentially enormous amount of solutions, each has different properties that may make it more or less desirable than another, criteria are required to find an optimal solution.
