...
\modelname contains definitions of concepts that enables the discussion and investigation of CSE.
...
A CUDF* document can be parsed to create an instances of \modelname.
