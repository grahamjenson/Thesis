...
This figure (and figures \ref{sim.modeldiagram}, \ref{impl.modelsatdiagram} and \ref{impl.modelofgjsolver}) 
are intended to show a simple overview of the relationships between the presented models.
To interpret this figure; each box is a model, \texttt{extends} is to mean inclusion and extension of semantics, 
\texttt{instantiates} means that a model is an instance of a higher model (also denoted with the prefix \texttt{:}),
and \texttt{parsed to} describes a model transformation.
