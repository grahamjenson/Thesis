...
This chapter describes the model (\modelname) and syntax (CUDF*) used to describe the CSE process. 
...
This chapter first 
defines the \modelname model then the CUDF* syntax.
...
\section{CUDF* Syntax}
\label{formal.cudf}
For \modelname to be of use to study CSE, a syntax to describe CSE problems is required.
As mentioned already, this new syntax is defined as CUDF* which extends and combines the Common Upgradeability Description Format (CUDF)\footnote{This specification was previously discussed in section \ref{background.models}, with an example shown in figure \ref{CUDFmetadata}.
}
...
Mancoosi looks at various problems within this domain and has made many contributions.
