...
The function  $install(pf)$ is defined to take a package formula $pf$ and returns one install constraint $\bigvee packagesThatSatisfy(pf)$.
...
The function remove is defined to 
