...
To solve such component evolution problems they must be represented formally, i.e. their semantics must be defined.
...
To solve component evolution problems, their representation must be efficiently expressed in a language, i.e. their syntax must be defined.
...
In this chapter the semantics and syntax of the evolution of a component system are formally defined.
The core atomic operation when evolving a component system is described as an evolution problem, the change made to the system at the user's requests.
