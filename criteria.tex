...
%%%Both forces are caused because of risk, risk of change introducing new problems, risk of not changing having old bugs there
...
%%%The reasons for minimal change, is that through change unknown bugs could be introduced.
...
\subsection{P2}
%%%Looiking at the criteria from the P2 solver
