...
\newcommand {\modelname}{CoSyE\xspace}
\newcommand {\modelimpl}{CoSyEImpl\xspace}
\newcommand {\modelnamewx}{CoSyE}
\newcommand {\modelimplwx}{CoSyEImpl}
...
\newcommand{\digraph}[3][scale=1]{ 
  ...
  \immediate\write18{bash -c "dot -Tps2 #2.dot | epstopdf --filter -o=#2.pdf"}  
  \IfFileExists{#2.pdf}
