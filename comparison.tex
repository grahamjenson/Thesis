...
%%%Things like how often versions are released, how often they change their dependencies, and how many different ``popular packages'' there are

%%%We can look at popular packages in both with app-install-data and also repository
