...
\label{comparison}
%%%An important issue when looking at this problem of CDR  can criteria from one be generalisable to another.

%%%These investigations outline the first investigations into the structure of component dependencies, for the possible generalisation of our results
