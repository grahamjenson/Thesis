...
%%%The users strategy
The aims of this research are to study the process of component system evolution.
As the users are also the composers of the component system, their role in this process must be explored.
...
\begin{defs}
	The added components criterion is defined to minimise the function $f_{l_1}(l_2) = 1.a_1 + \ldots + 1.a_n$
...
\begin{defs}
	 The removed components criterion is defined to minimise the function $f_{l_1}(l_2) = 1.a_1 + \ldots + 1.a_n$
	where $\{a_1,\ldots,a_n\} = \{\neg x \mid x \in \mathbb{C} \wedge x \in l_1\}$.
...
\begin{defs}
	 The changed components criterion is defined to minimise the function $f_{l_1}(l_2) = 1.a_1 + \ldots + 1.a_n$
	where $\{a_1,\ldots,a_n\} = \{\neg x \mid x \in \mathbb{C} \wedge x \in l_1 \} \cup \{x \mid x \in \mathbb{C} \wedge \neg x \in l_1 \}$.
...
\begin{defs}
	The version criterion is defined to maximise the pseudo-Boolean function $f_{l_1}(l_2) = a_1$.\verb+version+$.a_1 + \ldots + a_n$.\verb+version+$.a_n$
