...
\begin{figure}[htp]
\begin{center}
\digraph[scale=0.5]{criteriamapping}{
rankdir=BT
subgraph {
	rank=same;
	PB [label=<<TABLE BORDER="0" CELLBORDER="1" CELLSPACING="5"><TR><TD WIDTH="150">PB Criteria</TD></TR></TABLE>> shape=none];
	MOF [label=<<TABLE BORDER="0" CELLBORDER="1" CELLSPACING="5"><TR><TD WIDTH="150">MOF</TD></TR></TABLE>> shape=none];
	\modelnamewx [label=<<TABLE BORDER="0" CELLBORDER="1" CELLSPACING="5"><TR><TD WIDTH="150">\modelnamewx_criteria</TD></TR></TABLE>> shape=none];
}
subgraph {
	rank=same;
	PBI [label=<<TABLE BORDER="0" CELLBORDER="1" CELLSPACING="5"><TR><TD WIDTH="150">:PB Criteria</TD></TR></TABLE>> shape=none];
	MOFI [label=<<TABLE BORDER="0" CELLBORDER="1" CELLSPACING="5"><TR><TD WIDTH="150">:MOF</TD></TR></TABLE>> shape=none];
	IM [label=<<TABLE BORDER="0" CELLBORDER="1" CELLSPACING="5"><TR><TD WIDTH="150">:\modelnamewx_criteria</TD></TR></TABLE>> shape=none];
}
PBI -> PB [ label = "instantiates"];
MOFI -> MOF [ label = "instantiates"];
IM -> \modelnamewx [ label = "instantiates"];
MOFI -> IM [ label = "parses"];
IM -> PBI  [ label = "maps to"];
}
