...
\subsubsection{Conflict Learning}
...
The smaller the clause the more of the search tree is pruned when it is added to the formula.

\subsubsection{Backjumping}
Backjumping \citep{Gaschnig1979} is the technique which determines how far to up the search tree to backtrack, and then ``jumps'' up multiple levels to reduce the search space.
This algorithm typically depends on the clause created through conflict learning in modern solvers by backjumping to a level where this clause is unit.
