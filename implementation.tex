...
%%%These simplifications are mostly necessary for this problem as it keeps the problem pragmatically managable,
%%%and including all aspects of our formal optimisation framwork would be practically impossible
...
\section{Solvers}
%%%Here we first discuss the specific implementation of P2CUDF then our implementation.
...
%%%What I expect are consistent results that are comparable to other better solvers.
