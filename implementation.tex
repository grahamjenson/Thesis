...
For an assignment $\{a , \neg b, \neg c\}$, this equation would resolve to $1 + 2 + 0 \geq 3$, which is true therefore this assignment satisifes this constraint.
...
Also given the proper amendments to unit propagation and other algorithm, 
