\chapter{GJSolver: \modelname implementation}
...
\modelnamewx [label=<<TABLE  BORDER="0" CELLBORDER="1" CELLSPACING="5">
	<TR><TD WIDTH="150">\modelnamewx</TD></TR>
</TABLE>> shape=none];
\modelimplwx [label=<<TABLE  BORDER="0" CELLBORDER="1" CELLSPACING="5">
	<TR><TD WIDTH="150">\modelimplwx</TD></TR>
</TABLE>> shape=none];
subgraph {
	rank=same;
	FMI [label=<<TABLE BORDER="0" CELLBORDER="1" CELLSPACING="5"><TR><TD WIDTH="150">:\modelnamewx</TD></TR></TABLE>> shape=none];
	IMI [label=<<TABLE BORDER="0" CELLBORDER="1" CELLSPACING="5"><TR><TD WIDTH="150">:\modelimplwx</TD></TR></TABLE>> shape=none];
}
SATPB -> SAT [label=extends];
FMI -> \modelnamewx [ label = "instantiates"];
IMI -> \modelimplwx [ label = "instantiates"];
IMI -> FMI [label=maps dir=both]
...
\begin{enumerate}
  ...
  where $f$ described with the tuple of literals $\langle a_1 ,\ldots , a_n\rangle$ and the tuple of natural numbers $\langle 1_1,\ldots,1_n \rangle$, %TODO not correct
\end{enumerate}
...
This leads to the mapping definition:
\begin{defs}
...
This criteria expressed the preference of either components $a$ or $b$ (or both) in the system.
