...
The problem of finding a solution to an evolution problem is NP-Complete, and the problem of finding an optimal solution is NP-Hard.
In addition, a component system is repeatedly evolved by a user who may wait for a solution to be found.
